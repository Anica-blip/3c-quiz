...
<head>
    ...
    <title>Quiz App - Fixed Version</title>
    <style>
        html, body {
          margin: 0;
          padding: 0;
        ...
        .cover-btn-in-img {
          ...
          width: max-content;
          min-width: 120px;
          /* FIX 1: Center align text in start button */
          display: flex;
          align-items: center;
        ...
        .main-btn {
          ...
          /* FIX 1: Ensure all buttons have centered text */
          display: flex;
          align-items: center;
          justify-content: center;
          text-align: center;
        ...
        /* FIX 2: Better positioning for quiz blocks */
        .page-content {
          position: absolute;
          left: 0;
          top: 0;
        ...
        /* FIX 2: Improved block positioning - especially for pre-results and results pages */
        .block-title,
        .block-desc,
        .block-question,
        .block-answer,
        .block-result {
          ...
          /* FIX 2: Better text alignment for different page types */
          display: flex;
          align-items: flex-start;
        }

        /* FIX 2: Specific styling for pre-results and results pages */
        .page-pre-results .block-title,
        .page-result .block-title,
        .page-result .block-desc {
          justify-content: center;
          text-align: center;
          align-items: center;
        }
    ...
    style="background:#007bff;color:#fff;border:none;padding:12px 24px;border-radius:8px;cursor:pointer;font-size:16px;">Reload</button>
        ...
        const PAGE_LAYOUTS = {
         ...
         result: {
          ...
          preResults: {
            title: { x: 22, y: 109, width: 272, height: 280 }
          },
